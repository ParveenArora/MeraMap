...
if __name__ == "__main__":
    ...
    # World
    bbox = (old_southWest_lat,old_southWest_lng, old_northEast_lat,old_northEast_lng)

    render_tiles(bbox, mapfile, tile_dir, 0, 0, "World")

    minZoom = old_minizoomlevel
    maxZoom = old_maxzoomlevel
    bbox = (old_southWest_lat,old_southWest_lng, old_northEast_lat,old_northEast_lng)
    #bbox = (75.724,20.212, 76.047,30.97)
    render_tiles(bbox, mapfile, tile_dir, minZoom, maxZoom)

    # Muenchen
#    bbox = (75.16,30.29, 76.69,31.48)
